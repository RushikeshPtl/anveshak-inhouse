...
from .views import ReviewerAssignedEventsViewSet,AuthorViewSet,ReviewerCommentsViewSet,AssignReviewer,FetchReviewerEvent,FetchReviewerEventCount,AssignContentWriter,ContentWriterProfileViewSet,FetchEventReviewersLog,EventStatus
...
router.register('assign-content-writer',viewset=AssignContentWriter,basename='assign content-writer')
router.register('content-writer-profile',viewset=ContentWriterProfileViewSet,basename='content-writer-profile')
